...
import { SnHeaderDefaultComponent } from './sn-header-default.component';

describe.skip('Sn Header Default Component', () => {
  let fixture: ComponentFixture<SnHeaderDefaultComponent>;
  let element: HTMLElement;
  let component: SnHeaderDefaultComponent;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnHeaderDefaultComponent);
