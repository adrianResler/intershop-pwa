...
import { SnLanguageSwitchComponent } from './sn-language-switch.component';

describe.skip('Sn Language Switch Component', () => {
  let component: SnLanguageSwitchComponent;
  let fixture: ComponentFixture<SnLanguageSwitchComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [MakeHrefPipe, MockComponent(FaIconComponent), SnLanguageSwitchComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnLanguageSwitchComponent);
