 ...
 */
@Component({
  selector: 'sn-sub-category-navigation',
  templateUrl: './sn-sub-category-navigation.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SnSubCategoryNavigationComponent implements OnInit {
  @Input() view = 'auto';
