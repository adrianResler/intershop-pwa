...
describe.skip('Sn Sub Category Navigation Component', () => {
  let fixture: ComponentFixture<SnSubCategoryNavigationComponent>;
  let component: SnSubCategoryNavigationComponent;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [MockComponent(FaIconComponent), SnSubCategoryNavigationComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnSubCategoryNavigationComponent);
