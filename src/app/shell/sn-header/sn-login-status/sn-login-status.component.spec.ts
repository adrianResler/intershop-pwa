...
import { SnLoginStatusComponent } from './sn-login-status.component';

describe.skip('Sn Login Status Component', () => {
  let component: SnLoginStatusComponent;
  let fixture: ComponentFixture<SnLoginStatusComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [MockComponent(FaIconComponent), SnLoginStatusComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnLoginStatusComponent);
