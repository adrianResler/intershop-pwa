...
import { SnUserInformationMobileComponent } from './sn-user-information-mobile.component';

describe.skip('Sn User Information Mobile Component', () => {
  let component: SnUserInformationMobileComponent;
  let fixture: ComponentFixture<SnUserInformationMobileComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnUserInformationMobileComponent);
