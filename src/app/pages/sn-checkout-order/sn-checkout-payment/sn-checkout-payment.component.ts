 ...
 */
@Component({
  selector: 'sn-checkout-payment',
  templateUrl: './sn-checkout-payment.component.html',
  changeDetection: ChangeDetectionStrategy.Default,
})
export class SnCheckoutPaymentComponent implements OnInit, OnChanges, OnDestroy {
  @Input() basket: Basket;
