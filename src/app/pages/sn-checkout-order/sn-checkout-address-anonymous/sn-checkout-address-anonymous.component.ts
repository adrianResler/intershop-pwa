 ...
 */
@Component({
  selector: 'sn-checkout-address-anonymous',
  templateUrl: './sn-checkout-address-anonymous.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SnCheckoutAddressAnonymousComponent implements OnChanges, OnInit, OnDestroy {
  @Input() basket: Basket;
