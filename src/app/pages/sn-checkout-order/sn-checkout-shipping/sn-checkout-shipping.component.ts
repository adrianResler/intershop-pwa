...
@Component({
  selector: 'sn-checkout-shipping',
  templateUrl: './sn-checkout-shipping.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SnCheckoutShippingComponent implements OnInit, OnChanges, OnDestroy {
  @Input() basket: Basket;
