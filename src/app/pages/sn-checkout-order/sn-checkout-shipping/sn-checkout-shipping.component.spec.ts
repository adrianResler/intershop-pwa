...
import { SnCheckoutShippingComponent } from './sn-checkout-shipping.component';

describe('Sn Checkout Shipping Component', () => {
  let component: SnCheckoutShippingComponent;
  let fixture: ComponentFixture<SnCheckoutShippingComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnCheckoutShippingComponent);
