...
import { SnCheckoutAddressComponent } from './sn-checkout-address.component';

describe('Sn Checkout Address Component', () => {
  let component: SnCheckoutAddressComponent;
  let fixture: ComponentFixture<SnCheckoutAddressComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnCheckoutAddressComponent);
